  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg pb-safe z-50 md:hidden">
      <div className="flex justify-around items-center h-16 px-2">
        <button 
          onClick={onTransport}
          className="flex flex-col items-center justify-center w-full h-full text-gray-600 active:text-primary active:bg-gray-50 rounded-lg transition-colors"
        >
          <Bus size={24} />
        ...
        <button 
          onClick={onEmergency}
          className="flex flex-col items-center justify-center w-full h-full text-red-600 active:bg-red-50 rounded-lg transition-colors relative -top-4"
        >
          <div className="bg-red-600 text-white p-3 rounded-full shadow-lg border-4 border-white">
