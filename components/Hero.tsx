    ...
    <section className="bg-primary text-white pt-8 pb-12 rounded-b-[2.5rem] shadow-xl relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            <p className="text-blue-200 text-sm font-medium">Estás en</p>
          ...
          <div className="flex flex-col items-end">
             <div className="bg-white/10 border border-white/20 rounded-full px-3 py-1 flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-white uppercase tracking-wide">Info Oficial</span>
             </div>
             <p className="text-[10px] text-blue-200 mt-1">Ley de Extranjería 2024</p>
          </div>
        </div>
        ...
        <p className="text-blue-100 mb-6">Tu kit de ayuda inmediata en Belgrado.</p>
        ...
        <div className="relative mb-8">
          <div className="relative shadow-lg z-20">
            <input 
              ...
              placeholder="Buscar: médico, policía, papeles..." 
            ...
            <div className="absolute top-16 left-0 right-0 bg-white rounded-xl shadow-xl z-30 overflow-hidden border border-gray-100 animate-in fade-in slide-in-from-top-2">
              {results.map((item) => (
                <button
                  ...
                  className="w-full text-left px-4 py-3 hover:bg-gray-50 active:bg-gray-100 active:scale-[0.99] transition-all flex items-center justify-between border-b border-gray-50 last:border-0"
                >
                  <div>
      ...
      >
        <div className="space-y-3">
          <p className="text-sm text-gray-600 mb-4">
            Toca para llamar. Funcionan 24 horas, todos los días.
          </p>
          
          <a href="tel:194" className="flex items-center gap-4 p-4 bg-red-50 border border-red-100 rounded-xl hover:bg-red-100 active:scale-95 transition-all">
          ...
          <a href="tel:192" className="flex items-center gap-4 p-4 bg-blue-50 border border-blue-100 rounded-xl hover:bg-blue-100 active:scale-95 transition-all">
          ...
          <a href="tel:193" className="flex items-center gap-4 p-4 bg-orange-50 border border-orange-100 rounded-xl hover:bg-orange-100 active:scale-95 transition-all">
      ...
      >
        <div className="text-center py-6">
          ...
          <p className="text-gray-600 mb-6 text-sm">
            Si quieres, puedes compartir tu ubicación con un amigo o familiar para que ellos también estén tranquilos.
          </p>
